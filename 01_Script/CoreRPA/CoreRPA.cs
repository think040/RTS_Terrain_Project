...
public class CoreRPA : RenderPipelineAsset
{
    protected override RenderPipeline CreatePipeline()
    {
        ...
        {
            define = new string[] { "DirectX", "OpenGL_Non", "Vulkan_Non" };
        }
        else if (gdt == GraphicsDeviceType.OpenGLCore || gdt == GraphicsDeviceType.OpenGLES3)
        {
            define = new string[] { "DirectX_Non", "OpenGL", "Vulkan_Non" };
        }
        else if (gdt == GraphicsDeviceType.Vulkan)
        {
            define = new string[] { "DirectX_Non", "OpenGL_Non", "Vulkan" };
        }
...
public static class RenderGOM
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static void InvertBackFaceCulling(CommandBuffer cmd, bool value)
    {
#if (DirectX || Vulkan)
            cmd.SetInvertCulling(value);
#endif       
